...
- Name: financeiro.spec.ts >> página a receber carrega os cards de totais
- Location: e2e\financeiro.spec.ts:10:5
...
Locator: getByRole('heading', { name: 'Contas a Receber' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Contas a Receber' })
