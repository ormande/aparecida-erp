...
- Name: ordens-de-servico.spec.ts >> botão "Nova OS" navega para /ordens-de-servico/nova
- Location: e2e\ordens-de-servico.spec.ts:9:5
...
Call log:
  - waiting for getByRole('link', { name: /Nova OS/i })
